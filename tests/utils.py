...
def test(method, url, testname="", query_params={}, body=None, expected_body=None, expected_code=200, valid_check_order=True, files=None, headers={}, data=None):
    ...
    starttime = time.time()
    try:
        r = req_fn(url, params=query_params, data=requestbody, files=files, headers=headers)
